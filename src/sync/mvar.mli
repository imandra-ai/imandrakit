(** MVar.
    ...
    See for example
    {{:https://hackage.haskell.org/package/base-4.16.2.0/docs/Control-Concurrent-MVar.html}
     haskell} *)
...
(** [update_block mv f] takes [x] from [mv], calls [f], and puts the new state
    back into [mv]. It returns a secondary value. [f] is called in a critical
    section and should not block or take other locks; if it does, beware of
    deadlocks! *)
